...
> This application uses [spotify-wrapper](https://github.com/Manaia/spotify-wrapper) library to get informations and songs from Spotify.
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/Manaia/spotify-wrapper-player/tags).
